...
insert into movie (id, title, genre, release_year, trailer, director_name, picture, franchise_id) values (1, 'Three on a Weekend', 'Drama', 1986, 'http://boston.com/in/faucibus', 'Nixie', 'http://dummyimage.com/229x100.png/ff4444/ffffff',1);
